...
SHELL.main_window.title("Versatile Dialogs")
SHELL.center_window(height_=200)
SHELL.msg.config(width=200, font=('sans', 11, 'bold'))#, 'italic'))
#SHELL.msg.config(width=200, font=('sans', 10))  # , 'bold'))
#SHELL.msgtxt.set('Customize your settings')
SHELL.msgtxt.set('Settings:')
...
W3 = tk.OptionMenu(
    SHELL.main_window, VARIABLE3, "terminator -x", "gnome-terminal -x", "xterm -e")
W3.pack()
